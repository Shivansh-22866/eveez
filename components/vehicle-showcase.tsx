...
function VehicleShowcase({
  ...
  className="
    ...
    h-[clamp(320px,35vw,650px)]
    w-[clamp(320px,35vw,650px)]
    -translate-x-1/2 -translate-y-1/2
    rounded-full bg-foreground/[0.035] blur-3xl
  "
/>
...
<div
  className="
    ...
    h-[clamp(240px,27vw,500px)]
    w-[clamp(240px,27vw,500px)]
    -translate-x-1/2 -translate-y-1/2
...
function VehicleSlide({
  ...
  "
        ...
        {/* Vehicle */}
        <div className="relative flex h-[clamp(280px,42vh,500px)] w-full max-w-[100%] items-center justify-center">
          <motion.img
            src={vehicle.image}
            alt={vehicle.name}
            style={{
            ...
            className="
              ...
              max-w-[85%]
              object-contain
              drop-shadow-[0_35px_80px_rgba(0,0,0,0.35)]
            "
          />
          ...
          <FeatureIndicator
            ...
            label="Top speed"
            value={vehicle.speed}
            className="left-[51%] -translate-x-1/2 -bottom-2"
            accent={vehicle.accent}
          />
        ...
        <div className="mt-4 text-center lg:hidden">
          ...
          <h2 className="text-[clamp(2rem,3.5vw,4rem)] font-black tracking-[-0.07em]">
            {vehicle.name}
          </h2>
...
const VehicleProgress = ({
  ...
  return (
    <div className="absolute right-3 top-1/2 z-40 -translate-y-1/2 lg:right-5">
